                ...
                <div class="card-body">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" name="description" id="description" placeholder="Description&hellip;" value="{{ old('description') ?? $item->description }}" class="text-primary border-secondary p-1" required/></td>
                        </tr>
                        <tr>
